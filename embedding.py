...
#Vector Embeddings
db = Chroma.from_documents(persist_directory="./chromadb", documents=documents[:20],embedding=HuggingFaceEmbeddings(model_name='sentence-transformers/all-mpnet-base-v2'))
